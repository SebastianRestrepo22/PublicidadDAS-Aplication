...
export const ClienteModalForm = ({
  ...
  const isReadOnly = title.includes("Ver");
  const buttonLabel = title.includes("Nuevo") ? "Crear" : title.includes("Editar") ? "Guardar" : "Cerrar";
        ...
        <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-3 text-left">
          ...
          <div className="flex flex-col">
            ...
            <input
              ...
              readOnly={isReadOnly || title.includes("Editar")}
              disabled={cargandoFormulario}
              onChange={handleChanges}
              onBlur={!isReadOnly ? handleCedulaBlur : undefined}
              maxLength="10"
              className={`w-full h-10 px-3 border rounded-lg bg-white focus:outline-none focus:ring-2 focus:ring-blue-500 
                ${(submitted && !values.CedulaId.trim()) || cedulaError || cedulaFormatoError ? "border-red-500" : "border-gray-300"} ${(isReadOnly || title.includes("Editar") || cargandoFormulario) ? "bg-gray-100 cursor-not-allowed" : ""}`}
            />
          ...
          <div className="flex flex-col">
            ...
            <input
              ...
              onChange={handleChanges}
              className={`w-full h-10 px-3 border rounded-lg bg-white focus:outline-none focus:ring-2 focus:ring-blue-500
                ${submitted && !values.NombreCompleto.trim() ? "border-red-500" : "border-gray-300"} ${(isReadOnly || cargandoFormulario) ? "bg-gray-100 cursor-not-allowed" : ""}`}
            />
            <div className="min-h-[16px] mt-0.5">
          ...
          <div className="col-span-1 md:col-span-2 flex gap-4 mt-3">
            ...
            <button
              type="button"
              disabled={cargandoFormulario}
              className={`flex-1 ${isReadOnly ? "w-full" : ""} bg-gray-200 text-gray-700 py-2 rounded-lg hover:bg-gray-300 transition-colors
