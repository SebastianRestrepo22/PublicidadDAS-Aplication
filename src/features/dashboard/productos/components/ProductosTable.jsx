            ...
            <tbody className="divide-y divide-slate-100">
                {data.length > 0 ? (
                    data.map((p) => {
                        ...
                        const estado = productoConEstado.Estado;

                        return (
                            <tr key={productoConEstado.ProductoId} className={`hover:bg-slate-50 transition-colors duration-150 ${estado === 'Inactivo' ? 'bg-gray-50 opacity-75' : ''}`}>                                <td className="py-3 px-4 text-sm text-gray-700 truncate max-w-[100px]" title={p.ProductoId}>
                                ...
                                <td className="py-3 px-4">
                                    <div className="flex items-center gap-2">
                                        <button
                                            ...
                                            className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors duration-200 ${estado === 'Activo' ? 'bg-green-500 hover:bg-green-600' : 'bg-gray-300 hover:bg-gray-400'
                                                }`}
                                        >
                                            <span
                                                className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform duration-200 ${estado === 'Activo' ? 'translate-x-6' : 'translate-x-1'
                                                    }`}
                                            />
                                        </button>
                                ...
                                <td className="py-3 px-4">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <button
                                            ...
                                            title={estado === 'Activo' ? 'Editar' : 'Solo productos activos se pueden editar'}
                                        ...
                                        <button
                                            ...
                                            title={estado === 'Inactivo' ? 'Eliminar permanentemente' : 'Debe estar inactivo para eliminar'}
