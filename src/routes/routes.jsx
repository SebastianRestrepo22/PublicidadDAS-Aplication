...
export const Routers = () => {
    return (
        <Routes>
            ...
            <Route path="/cliente/MisPedidos" element={
                <PrivateRoute role="cliente">
                    <MisPedidos />
                </PrivateRoute>
            } />
            ...
            <Route path="/dashboard" element={
                ...
                <Route path="/dashboard/produccion/nuevo" element={<Produccion />} />
                <Route path="/dashboard/produccion/:id" element={<Produccion />} />
                <Route path="/dashboard/produccion/:id/editar" element={<Produccion />} />
